  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      <div className="md:flex-[0.5] flex-initial justify-center">
        <img src={logo} alt="logo" className="w-32 cursor-point" />
      </div>
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          <ul
            ...
            shadow-2x1 md:hidden list-node flex flex-col justify-start 
            items-end roudend-md blue-glassmorphism animate-slide-in"
          >
